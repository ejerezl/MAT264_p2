...
This can be used to simulate traffic jams as we can see in the graph . In this case cars are moving from left to right, but as time pass the traffic jam moves in the other direction. 
